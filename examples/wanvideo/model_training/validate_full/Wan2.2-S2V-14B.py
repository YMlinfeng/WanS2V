...
#     num_inference_steps=40
# )
# save_video_with_audio(video[1:], "ori.mp4", audio_path, fps=15, quality=5)
...
state_dict = load_state_dict("/m2v_intern/mengzijie/DiffSynth-Studio/models/train/Wan2.2-S2V-14B_T16/step-1200.safetensors")
#  state_dict = load_state_dict([f"models/Wan-AI/Wan2.2-I2V-A14B/high_noise_model/diffusion_pytorch_model-0000{i}-of-00006.safetensors" for i in range(1, 7)])
# state_dict = load_state_dict([f"models/Wan-AI/Wan2.2-I2V-A14B/low_noise_model/diffusion_pytorch_model-0000{i}-of-00006.safetensors" for i in range(1, 7)])
#wan2.1-T2V-14B
# state_dict = load_state_dict([f"models/Wan-AI/Wan2.1-T2V-14B/diffusion_pytorch_model-0000{i}-of-00006.safetensors" for i in range(1, 7)])
# train
# state_dict = load_state_dict("/m2v_intern/mengzijie/DiffSynth-Studio/models/train/Wan2.2-S2V-14B_t0/epoch-0.safetensors")
...
save_video_with_audio(video[1:], "loaded57-fix.mp4", audio_path, fps=16, quality=5)
